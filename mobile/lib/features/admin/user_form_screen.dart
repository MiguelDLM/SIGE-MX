  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await dio.post('/api/v1/users/', data: {
        ...
        'apellido_paterno': _apPaternoCtrl.text.trim().isEmpty ? null : _apPaternoCtrl.text.trim(),
        'apellido_materno': _apMaternoCtrl.text.trim().isEmpty ? null : _apMaternoCtrl.text.trim(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            TextField(controller: _emailCtrl, keyboardType: TextInputType.emailAddress, decoration: const InputDecoration(labelText: 'Correo electrónico', border: OutlineInputBorder())),
            const SizedBox(height: 12),
            ...
            const SizedBox(height: 12),
            TextField(controller: _passwordCtrl, obscureText: true, decoration: const InputDecoration(labelText: 'Contraseña *', border: OutlineInputBorder())),
            const SizedBox(height: 12),
            ...
            FilledButton(
              ...
              child: _saving ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Text('Crear usuario'),
            ),
          ],
        ),
      ),
